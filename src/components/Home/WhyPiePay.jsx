            ...
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-gray-100 pb-8">
                    ...
                    <p className="max-w-md text-gray-500 text-xl font-light leading-relaxed text-right md:text-left">
                        Experience the payment infrastructure designed for the modern
                        economy.
                    </p>
                </div>
                ...
                `}
                            >
                                ...
                                <div className="absolute inset-0 transition-opacity duration-700 opacity-100">
                                    ...
                                    <div
                                        className={`absolute inset-0 bg-gradient-to-t from-[#051B31] via-[#051B31]/80 to-transparent ${isActive
                                                ? "opacity-90"
                                ...
                                <div className="relative z-10 flex justify-between items-start w-full">
                                    <span
                                        className={`text-xl font-mono font-bold transition-colors duration-300 ${isActive ? "text-[#4686BC]" : "text-white/60"
                                            }`}
                                    >
                                        {item.id}
                                    </span>
                      ...
                      ${isActive
                                                ? "bg-[#4686BC] border-[#4686BC] text-white rotate-0"
                                                : "border-white/30 text-white/60 -rotate-90"
                                            }`}
                                    >
                    ...
                    `}
                                    ...
                                    {/* EDIT #2: Always visible on <lg, accordion visibility only on lg+ */}
                                    <div
                                        className={`
                      transition-all duration-500 transform opacity-100 translate-y-0
                      ${isActive
                                                ? "lg:opacity-100 lg:translate-y-0 lg:delay-100"
                                                : "lg:opacity-0 lg:translate-y-4 lg:absolute lg:bottom-0"
                                            }
                    `}
                                    >
